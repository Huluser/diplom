...
<td><?php echo $post['pokazaniawater']; ?></td>	
...
<input type="text" class="form-control" id="pokazaniawater" name="pokazaniawater" placeholder="Показание воды">
</div>
...
$pokazaniawater=$_POST['pokazaniawater'];
addPostavjiki($db, $apartment_number, $pokazaniawater);
}
?>
